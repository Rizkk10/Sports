...
//                self.awayTeamLogo = jsonData.compactMap { $0["event_second_player_logo"] as? Any }
//                self.homeTeamLogo = jsonData.compactMap { $0["event_first_player_logo"] as? Any }
//                self.eventDate = jsonData.compactMap { $0["event_date"] as? String }
